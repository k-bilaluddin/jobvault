        ...
        <div class="bg-surface-raised border border-border rounded-xl p-4 sm:p-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input v-model="form.gitHub.repository" placeholder="e.g. job-applications-vault"
                class="w-full bg-surface-overlay border border-border rounded-lg px-3 py-2 text-sm text-text-primary outline-none focus:border-accent"/>
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="form.gitHub.cvFileName" placeholder="e.g. FirstName_LastName_CV"
                class="w-full bg-surface-overlay border border-border rounded-lg px-3 py-2 text-sm text-text-primary outline-none focus:border-accent"/>
            ...
            <div>
              ...
              <input v-model="form.gitHub.coverLetterFileName" placeholder="e.g. FirstName_LastName_CoverLetter"
                class="w-full bg-surface-overlay border border-border rounded-lg px-3 py-2 text-sm text-text-primary outline-none focus:border-accent"/>
              <p class="text-[11px] text-text-muted mt-1">.docx and .pdf extensions added automatically</p>
            </div>
          </div>
